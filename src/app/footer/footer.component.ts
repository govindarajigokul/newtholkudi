...
export class FooterComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.showAbout = this.appConfig.info.enableAboutStatement;
    this.showCredits = this.appConfig.info.enableCreditsStatement;
    this.showHelp = this.appConfig.info.enableHelpStatement;
